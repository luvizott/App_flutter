              ...
              child: InkWell(
                child: Column(
                  ...
                  children: [
                    Icon(
                      Icons.home,
                      color: currItem == 0 ? Colors.white : Colors.grey,
                    ),
                    Text(
                      'Vendas',
                      style: TextStyle(color: currItem == 0 ? Colors.white : Colors.grey),
                    ),
                  ],
                ),
                onTap: () {
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      ...
                      color: currItem == 1 ? Colors.white : Colors.grey,
                    ),
                    Text(
                      'Sobre',
                      style: TextStyle(color: currItem == 1 ? Colors.white : Colors.grey),
                    ),
                  ],
                ),
                onTap: () {
